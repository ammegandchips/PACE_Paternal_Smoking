...
2) IQR log file: for each time point, one Rdata file labelled as YOURSTUDY.patsmoking.iqrlog.timepoint.Rdata.The code will generate this file for you. If you have multiple time points, you will have an Rdata file for each time point: birth, early.childhood, late.childhood, adolescence, or adult.
