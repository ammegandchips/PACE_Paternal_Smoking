...
* **Paternal social class (pat.ses):** binary numeric variable (1=high/0=low), please use your preferred classification, but note that our preference is for education level. *If you do not have paternal social class, please use maternal social class instead, but please indicate this in the Excel document. In order for the code to run, you should still call this variable 'pat.ses' even if you're using maternal ses*
