...
* **Paternal social class (pat.ses):** binary numeric variable (1=high/0=low), please use your preferred classification, but note that our preference is for education level.

* **Maternal social class (mat.ses):** binary numeric variable (1=high/0=low), please use your preferred classification, but note that our preference is for education level.
...
Methylation ~ Maternal active smoking + SVs for batch + Paternal age + Paternal BMI + Paternal socioeconomic status + Maternal age + Maternal BMI + Maternal social class + Parity + Estimated cell counts
